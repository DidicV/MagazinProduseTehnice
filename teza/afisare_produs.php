<?php 
include('sever.php'); 
$res3 = mysqli_query($db, "SELECT id_produs, denumirea, pretul, nr_stoc, nume_firma, nume_categorie FROM produse NATURAL JOIN firma, categorii WHERE id_prod=id_producator AND id_categ=id_categorii;");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
 ...
 <h2><center>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Lista produselor</center></h2>
