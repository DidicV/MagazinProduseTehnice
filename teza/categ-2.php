<?php 
include('sever.php');
$categorie_2=mysqli_query($db, "SELECT id_produs, denumirea, pretul, nr_stoc, nume_firma FROM produse JOIN firma WHERE id_prod=id_producator and id_categ=2;");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
 ...
 <h2><center>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Climatizare</center></h2>
...
<table border="1" style="border-radius: 15px 15px 15px 15px;">
    ...
    <tbody>
      ...
      <?php  while($row = mysqli_fetch_array($categorie_2)) { ?>
